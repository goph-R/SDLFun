...
echo === SDLFun Win10 MinGW Build (OpenAL) ===
echo.
...
set "OPTS=-O2 -DUSE_OPENAL -Ivendor_win10\include -Ivendor\bullet3-3.25\src"
...
REM ----------------------------------------------------------------
REM  Link (OpenAL32 instead of FMOD)
REM ----------------------------------------------------------------
echo Linking...
%GPP% main.o sdl_main.o bl.o bc.o bd.o -o SDLFun_w10_openal.exe -Lvendor_win10\lib -lmingw32 -lSDL -lopengl32 -lOpenAL32 -static-libgcc -static-libstdc++
if errorlevel 1 goto error
...
echo.
echo === Build successful! Run SDLFun_w10_openal.exe ===
goto end
