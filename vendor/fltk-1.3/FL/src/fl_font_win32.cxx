...
// Win98 / old-MinGW SDK back-fill (GGI_MARK_NONEXISTING_GLYPHS). windows.h is
// already in scope here via FL/x.H. SOOB-editor build patch -- not upstream.
#include "fl_win98_compat.h"
